...
{
  /* USER CODE BEGIN 6 */
  w25qxx_read(&w25qxx, blk_addr * USER_STORAGE_BLK_SIZ, buf, blk_len * USER_STORAGE_BLK_SIZ);
...
{
  /* USER CODE BEGIN 7 */
  w25qxx_write_with_erase(&w25qxx, blk_addr * USER_STORAGE_BLK_SIZ, buf, blk_len * USER_STORAGE_BLK_SIZ);
